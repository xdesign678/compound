  ...
  return (
    <div className={`modal-overlay ${isOpen ? 'visible' : ''}`} onClick={close}>
      ...
      >
        ...
        <div
          className={`settings-section settings-card settings-data-section${confirming === 'clear' ? ' is-confirming-danger' : ''}`}
          style={S.dataSection}
        >
          <div className="settings-card-head">
            <div className="settings-card-icon">
          ...
          {confirming === 'seed' ? (
            <>
              ...
              <button className="modal-btn" style={S.cancelBtn} onClick={() => setConfirming(null)}>
                取消
              </button>
            </>
          ) : confirming === 'clear' ? (
            <>
              ...
              <button className="modal-btn primary" style={S.clearBtn} onClick={clearAll}>
                确认清空
              </button>
              <button className="modal-btn" style={S.cancelBtn} onClick={() => setConfirming(null)}>
                取消
